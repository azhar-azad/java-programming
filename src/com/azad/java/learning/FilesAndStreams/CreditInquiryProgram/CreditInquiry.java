package com.azad.java.learning.FilesAndStreams.CreditInquiryProgram;
...
public class CreditInquiry {
    ...
    private static void readRecords(MenuOption accountType) {
        ...
        try (Scanner input = new Scanner(Paths.get("/home/azad/Workspaces/java/java-programming.git" +
