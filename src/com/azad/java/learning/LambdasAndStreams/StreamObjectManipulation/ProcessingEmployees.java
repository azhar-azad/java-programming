package com.azad.java.learning.LambdasAndStreams.StreamObjectManipulation;
...
public class ProcessingEmployees {
    ...
    public static void main(String[] args) {
        ...
        // Compare for comparing Employees by first name then last name
        ...
        System.out.printf("Sum of Employees' salaries (via reduce method): %.2f\n",
                list.stream()
                        .mapToDouble(Employee::getSalary)
                        .reduce(0, (sum, salary) -> sum + salary));

        // average of Employee salaries with DoubleStream average method
        System.out.printf("Average of Employees' salaries: %.2f\n",
                list.stream()
                        .mapToDouble(Employee::getSalary)
                        .average()
                        .getAsDouble());
