package com.azad.practice.java.CmdLineApps.PayrollSystemWithPolymorphism;
    ...
    public static void main(String[] args) {
        ...
        for (Employee employee: employees) {
            ...
            if (employee instanceof BasePlusCommissionEmployee) {
                ...
                bpcEmployee.setBaseSalary(1.10 * bpcEmployee.getBaseSalary());
