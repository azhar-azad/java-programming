package com.azad.practice.java.JavaCompleteRef.Jcr15LambdaExpressions.MethodReferences;
...
class InstanceMethWithObjectRefDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(count + " days had a high less then 89");

        count = counter(weekDayHighs2, HighTemp::lessThanTemp, new HighTemp(19));
        System.out.println(count + " days had a high less then 19");
    }
}
...
/**
     ...
     3 days had a high less then 89
     5 days had a high less then 19
 * */
