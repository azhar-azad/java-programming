package com.azad.practice.java.GenericCollections.Sets;
...
public class SortedSetTest {
    ...
    public static void main(String[] args) {
        ...
        printSet(tree.headSet("orange")); // subset where every element is less than "orange"

        // get tailSet based upon "orange"
        System.out.print("tailSet (\"orange\"): ");
        printSet(tree.tailSet("orange")); // subset where every element is greater than or equal to "orange"
